          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            {!scrolled && !mobileMenuOpen && (
              <a
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-navy-900 to-navy-700 rounded-lg sm:rounded-xl flex items-center justify-center hover:scale-110 transition-transform flex-shrink-0"
                aria-label="Call now"
              >
                <svg
